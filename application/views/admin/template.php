...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/template/adminlte3/'); ?>css/style.css">
  <!-- Select2 -->
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <footer class="main-footer">
      <strong>&copy; <?= date('Y') ?> All Right Reserve <a class="text-info" href="https://minarkhan.com" target="_BLANK">Moaref Billah</a></strong>

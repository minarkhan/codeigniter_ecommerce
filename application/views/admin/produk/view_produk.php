        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              ...
              <a class='float-right btn btn-primary btn-sm' href='<?= base_url('admin/tambah_produk'); ?>'>ADD Product</a>
            </div>
                ...
                <tbody>
                  ...
                  foreach ($record as $row) {
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>BDT. " . rupiah($row['harga_beli']) . "</td>
                              <td>BDT. " . rupiah($row['harga_konsumen']) . "</td>
                              <td>BDT. " . rupiah($row['diskon']) . "</td>

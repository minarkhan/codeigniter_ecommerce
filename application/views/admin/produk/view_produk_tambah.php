          ...
          <div class="card">
            ...
            <form action="<?= base_url('admin/tambah_produk') ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Coustomer Price</label>
                  <div class="col-sm-6">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">Product Informtion</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="customFileLangHTML" data-browse="Cari">Choose an image...</label>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href='<?= base_url('admin/produk') ?>'><button type='button' class='btn btn-secondary btn-sm ml-1'>Cancel</button></a>
                  </div>
                </div>

  ...
  <section class="content mb-5 mt-5">
    <div class="container-fluid">
      <div class="row">
        ...
        <?php
        $product = $this->db->query('SELECT * FROM tb_toko_produk');
        $Consumer = $this->db->query("SELECT * FROM tb_pengguna WHERE level='2'");
        $sales = $this->db->query('SELECT * FROM tb_toko_penjualan WHERE proses="3"');
        $Article = $this->db->query('SELECT * FROM tb_blog_artikel');
        ?>

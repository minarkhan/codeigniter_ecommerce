...
if ($this->uri->segment(2) == 'kategori') {
    ...
    if ($jumlah <= 0) { ?>
        <div class="text-center mt-3 mb-3">
            <h5>Sorry, the page you requested was not found</h5>
            <a class="btn btn-info btn-sm mt-2" href="#">Home</a>
        </div>
<?php }
} ?>
...
<div class="jumbotron jumbotron-fluid">
  <div class="container text-center">
    <h1 class="display-4">Fetured Products</h1>
    <p class="lead">Here you can see our fetured products </p>
  </div>
</div>

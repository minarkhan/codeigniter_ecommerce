...
if ($record->num_rows() == '0') { ?>
  <div class='text-center mt-3 mb-5'>
    <h3>Sorry, Shopping Cart anda saat ini masih kosong</h3><br>
    <a class='btn btn-info' href='<?= base_url('produk') ?>'>Klik disini Untuk mulai belanja.</a>
  </div>
<?php } else {
?>
    ...
    <div class="col-md-4">
      <div class="card w-100">
        <div class="card-body">
          ...
          </table><a class="btn btn-info btn-sm btn-block cart__checkout-button" href="<?= base_url('keranjang/checkouts') ?>">Process to Checkout</a>
        </div>
      </div>
    </div>

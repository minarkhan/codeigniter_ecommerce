            ...
            <div class="block block-sidebar block-sidebar--offcanvas--mobile">
                ...
                <div class="block-sidebar__body">
                    <div class="block-sidebar__header">
                        <div class="block-sidebar__title">category</div>
                    ...
                    <div class="block-sidebar__item">
                        <div class="widget-filters widget widget-filters--offcanvas--mobile" data-collapse data-collapse-opened-class="filter--opened">
                            <h4 class="widget-filters__title widget__title">category</h4>
                                            ...
                                            <div class="widget-products__info">
                                                ...
                                                <div class="widget-products__prices">
                                                    <?php if ($rowz['diskon'] == '0') { ?>
                                                        BDT. <?= rupiah($rowz['harga_konsumen']) ?>
                                                    <?php } else { ?>
                                                        <small><del>BDT. <?= rupiah($rowz['harga_konsumen']) ?></del></small>
                                                        BDT. <?= rupiah($rowz['harga_konsumen'] - $rowz['diskon']) ?>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-card">
                                            ...
                                            <div class="product-card__actions">
                                                <div class="product-card__prices">
                                                    <?php if ($row['diskon'] == '0') { ?>
                                                        BDT. <?= rupiah($row['harga_konsumen']) ?>
                                                    <?php } else { ?>
                                                        <small><del>BDT. <?= rupiah($row['harga_konsumen']) ?></del></small>
                                                        BDT. <?= rupiah($row['harga_konsumen'] - $row['diskon']) ?>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                        </div>

    ...
    <div class='col-lg-4 col-md-6'>
      <table class="table table-borderless table-sm">
        <tr>
          ...
          <td class="text-left">BDT. <?= rupiah($total['total'] + $total['ongkir']); ?></td>
        </tr>
        <tr>
  ...
  <table class="table table-borderless table-sm mt-3" id='tablemodul1'>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><b>BDT. <?= rupiah($total['total']) ?></b></td>
      </tr>

      <tr>
        <td colspan='4'><b>Ongkir </b></td>
        <td><b>BDT. <?= rupiah($total['ongkir']) ?></b></td>
      </tr>

      <tr>
        <td colspan='4'><b>Total Bayar</b></td>
        <td class="border border-dark"><b>BDT. <?= rupiah($total['total'] + $total['ongkir']); ?></b>
        <td>
      </tr>

                ...
                <div class="form-group product__option">
                    ...
                    <div class="product__actions">
                        ...
                        <div class="product__actions-item product__actions-item--addtocart">
                            <a href="javascript:void(0)" class="btn btn-info btn-lg" onclick="add2cart()">Add to Cart</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-9 col-xl-8">
                            ...
                            <div class="form-group mb-0">
                                <button type="submit" name="submit" class="btn btn-info btn-lg">Tulis Ulasan</button>
                            </div>
                        </div>
                    </div>
                </form>

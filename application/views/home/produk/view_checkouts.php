    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card w-100 shadow mb-2 bg-white rounded">
                <div class="card-body">
                    <h6 class="float-left">Shipping address</h6>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td>
                                <small>Compleate Address</small><br>
                    ...
                    <table class="table table-borderless" style="width: 100%">
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="width: 35%">
                                    BDT. <span class="float-right"><?= rupiah($sub_total) ?></span>
                                </td>
                                <td style="width: 5%">
                    ...
                    <table class="table table-borderless">
                        <tr>
                            <td>
                                ...
                                <strong>BDT. <?= rupiah($total['total']) ?></strong>
                            </td>
                        </tr>

                        <tr>
                            <td>
                                <small>Delivery Fee of</small><br>
                        ...
                        <tr>
                            <td>
                                <button type='submit' name='submit' id='oksimpan' class='btn btn-info btn-block btn-sm' style='display:none'>
                                    Bayar
                                </button>
                            </td>
                        </tr>

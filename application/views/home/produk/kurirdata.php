...
?>
		...
		<input onclick="show2();" type="radio" name="service" class="service" data-id="<?php echo $i; ?>" value="<?php echo $service; ?>" /> &nbsp; <?php echo $deskripsi; ?> <br /> <span class="ml-4">(BDT. <?php echo number_format($tarif, 0); ?> , <?php echo $waktu; ?> hari)</span> <br />
		<hr>

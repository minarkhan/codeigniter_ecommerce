              ...
              <tbody>
                ...
                foreach ($record as $row) {
                  ...
                  echo "<tr><td>$no</td>
                              ...
                              <td style='color:red;'>BDT. " . rupiah($total['total'] + $total['ongkir']) . "</td>
                              <td>$proses</td>
                              <td>" . cek_terakhir($row['waktu_transaksi']) . " lalu</td>
                              <td>
                                <a class='btn btn-info btn-xs' title='Download' href='" . base_url() . "page/download/$row[kode_transaksi]' target='_BLANK'>Download</a>

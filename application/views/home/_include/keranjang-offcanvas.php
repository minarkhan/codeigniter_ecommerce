<div class="dropcart dropcart--style--offcanvas">
    ...
    <div class="dropcart__body">
        <div class="dropcart__header">
            <div class="dropcart__title">Shopping Cart</div><button class="dropcart__close" type="button"><svg width="12px" height="12px">
                ...
                <div class="dropcart__product">
                    <div class="dropcart__product-info">
                        <div class="dropcart__product-name text-center py-3">
                            <h4>Empty basket</h4> <br>
                            <a href="<?= base_url('produk') ?>" class="btn btn-info text-white"> Shop Now</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="dropcart__totals">
                <table>
                    <tr>
                        ...
                        ?>
                        <th>Subtotal</th>
                        <td>BDT. <?= rupiah($total['total']); ?></td>
                    </tr>

                </table>
            </div>
            <div class="dropcart__buttons">
                <a class="btn btn-secondary" href="<?= base_url('keranjang') ?>">Basket</a>
                <a class="btn btn-info" href="<?= base_url('keranjang/checkouts') ?>">Checkout</a>
            </div>
        <?php } ?>

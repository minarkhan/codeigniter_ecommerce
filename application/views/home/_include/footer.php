<footer class="bg-dark text-light site__footer">
    <div class="site-footer border-top-0">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="site-footer__widget footer-contacts text-justify pl-2">
                            ...
                            <ul class="footer-contacts__contacts">
                                <table class="text-light table table-borderless table-sm">
                                    <tr>
                    ...
                    <div class="col-12 col-md-12 col-lg-4">
                        <div class="site-footer__widget footer-newsletter">
                            ...
                            <div class="footer-newsletter__text">Subscribe now, and get the latest information from us.</div>
                            <form action="<?= base_url('subscribe') ?>" method="POST" class="footer-newsletter__form">
                                <label class="sr-only" for="footer-newsletter-address"> Email Address</label>
                                <input name="email" type="text" class="footer-newsletter__form-input form-control" id="footer-newsletter-address" placeholder="Email Address...">
                                <button name="submit" type="submit" class="footer-newsletter__form-button btn btn-info">Subscribe</button>
                            </form>
            ...
            <div class="site-footer__bottom">
                <div class="site-footer__copyright">&copy; <?= date('Y') ?> All Right Reserve<a href="https://minarkhan.com/" target="_BLANK">Moaref Billah</a></div>
